...
class DBHelper extends Database
{
    ...
    {
        return $this->query("INSERT INTO tblservicerecord (servicename, servicedescription, price)
                                VALUES ('$servicename', '$servicedescription', '$price')");
    }
    ...
    {
        $sql = "DELETE FROM tblservicerecord WHERE serviceid = $id";
        $this->query($sql);
    }
    ...
    function update_servicerecord($serviceid, $servicename, $servicedescription, $price)
    {
        $sql = "UPDATE tblservicerecord SET servicename = '$servicename', servicedescription = '$servicedescription', price = '$price' WHERE serviceid = $serviceid";
        return $this->query($sql);
    }
    ...
    function get_servicerecord($serviceid)
    {
        $sql = "SELECT * FROM tblservicerecord WHERE serviceid = $serviceid";
        $rs = $this->query($sql);
        $row = $rs->fetch_row();
        return array(
            "servicename" => $row[1],
